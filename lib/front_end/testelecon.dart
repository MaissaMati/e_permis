                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return RaisedButton(
                          ...
                          highlightColor: bleu,
                          splashColor: bleu,
                          color: Colors.white, //color[index],
                          ...
                          onPressed: buttonactive
                              ? () {
                                  ...
                                  appren.getTrace.archiveReponse.add(rep);
                                  rep.evaluer();
                                  ...
                                  if ((rep.decision == false) && (nbReponseFausse != 2)) {
                                    ...
                                    reponsecolor = bleu.withOpacity(0.5);
                                    //debugPrint("Correct");
                                    showDialog(
                                      barrierDismissible: false,
                                      context: context,
    ...
    setState(
      () {
        if (questionNumber == list_questions.length - 1) { 
          ...
          if(finalScore>=(scoretotal/2)) appren.consulter_lecon(lecon);
